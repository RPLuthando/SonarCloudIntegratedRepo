...
class ResultsBackup extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('results_backup', function (Blueprint $table) {
            $table->increments('id'); 
            ...
            $table->decimal('current_score', 5, 2)->default(0.00);
    ...
    {
        Schema::dropIfExists('results_backup');
    }
}
