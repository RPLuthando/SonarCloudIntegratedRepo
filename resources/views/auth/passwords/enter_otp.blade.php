...
<div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('OTP verification Forgot Password') }}</div>
                    <?php //print_r($otp); ?>
                    <div class="card-body">
                        <form method="POST" id="sendOtpForm">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <input id="otp_val" type="text" class="form-control{{ $errors->has('otp') ? ' is-invalid' : '' }}" name="otp" pattern="^\d{6}$" value="" required autofocus>
